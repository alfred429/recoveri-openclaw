...
# Version: v1.0
# Sprint: 6 | Milestone: FM5 (Daily Operating Rhythm), FM6 (Google Drive Governance)
...
### Creating Events
```bash
gog calendar create --title "{title}" --start "{ISO datetime}" --end "{ISO datetime}" --description "{desc}"
```
